...
$rs = $conn -> prepare ("SELECT * FROM img_inf_produto") or die ("Erro na string SELECT.");
          ...
          <div class="col-xs-3">
                <div class="form-group">
                  <select class="form-control" id="operacao" name="operacao">
                  	<option value="2" selected="selected">Informações de Produtos</option>
		...
		if ($rs -> execute()){ ?>
			<table class="tablesorter">
                ...
                <tbody>
                    ...
                    <tr>
                      <td align="center"><a href=edit_inf_produto.php?cod_inf_produto=<?php print $row->cod_inf_produto;?>><?php print $row->cod_inf_produto;?></a></td>
                      <td><a href=edit_inf_produto.php?cod_inf_produto=<?php print $row->cod_inf_produto;?>><?php print $row->nome_produto;?></a></td>
                      <td><a href=edit_inf_produto.php?cod_inf_produto=<?php print $row->cod_inf_produto;?>><?php print $row->inf_produto;?></a></td>
                      <td align="center"><a href=edit_inf_produto.php?cod_inf_produto=<?php print $row->cod_inf_produto;?>><img width="70px" height="70px" src="<?php print $img_inf_produto;?>"/></a></td>
                      <td align="center"><br />
                      <a href="javascript:del_inf_produto(<?php print $row->cod_inf_produto;?>);" ><img src="../images/menu_adm/apagar.png" title="Apagar"></a>
                      </td>
                    <?php } ?>
                </tbody>
			</table>
